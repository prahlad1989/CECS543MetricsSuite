 ...
 * @author prahlad
 */
public class TCFAdjustDialogue extends ValueAdjustmentsDialogue{
    protected String[] valueAdjustStrs = {
     ...
     public TCFAdjustDialogue(String panelName, MainFrame parent, FPMetricsFormPanel fPMetricsFormPanel) {
...
//                                }
//                                ;
//                                fPMetricsFormPanel.updateVAF(calculateFinalVAF(vafSum));
//                                
//			}
//		});
//
